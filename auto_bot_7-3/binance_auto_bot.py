...
#최근 3개의 5일선 데이터
print("5ma: ",myBinance.GetMA(df_15, 5, -3), "->",myBinance.GetMA(df_15, 5, -2), "->",myBinance.GetMA(df_15, 5, -1))
#최근 3개의 RSI14 데이터
print("RSI14: ",myBinance.GetMA(df_15, 14, -3), "->",myBinance.GetMA(df_15, 14, -2), "->",myBinance.GetMA(df_15, 14, -1))
...
#RSI14 정보를 가지고 온다.
rsi14 = myBinance.GetMA(df_15, 14, -1)
